...
function cleanupSvg(svg, keepFillColor, extractedWidth, extractedHeight) {
  var height = 'typeof height === "number" ? height : (' + extractedHeight + ' || size || 0)';
  var width = 'typeof width === "number" ? width : (' + extractedWidth + ' || size || 0)';
